...
latex_documents = [
    (master_doc, 'geone.tex', 'geone Documentation',
     'Julien Straubhaar', 'manual'),
]
...
man_pages = [
    (master_doc, 'geone', 'geone Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'geone', 'geone Documentation',
     author, 'geone', 'One line description of project.',
     'Miscellaneous'),
]
...
epub_exclude_files = ['search.html', '**.ipynb_checkpoints']
